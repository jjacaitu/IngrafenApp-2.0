...
class OrdenesSolicitadas(models.Model):
    ...
    descripcion_material_ot = models.CharField(max_length=90,null=True,blank=True)
    ...
    descripcion_material2_ot = models.CharField(max_length=90,null=True,blank=True,default="")
    ...
    descripcion_material3_ot = models.CharField(max_length=90,null=True,blank=True,default="")
    ...
    descripcion_material4_ot = models.CharField(max_length=90,null=True,blank=True, default="")
    ...
    descripcion_material5_ot = models.CharField(max_length=90,null=True,blank=True, default="")
    ...
    detalles_ot = models.CharField(max_length=1200, blank=True,null=True)
...
class CotizacionesSolicitadas(models.Model):
    ...
    descripcion_material = models.CharField(max_length=90,null=True,blank=True)
    ...
    descripcion_material2 = models.CharField(max_length=90,null=True,blank=True,default="")
    ...
    descripcion_material3 = models.CharField(max_length=90,null=True,blank=True,default="")
    ...
    descripcion_material4 = models.CharField(max_length=90,null=True,blank=True, default="")
    ...
    descripcion_material5 = models.CharField(max_length=90,null=True,blank=True, default="")
    ...
    detalles = models.CharField(max_length=1200, blank=True,null=True)
